...
<br />
<div class="dashBlue HighLighted"><a href='/#' style="color:#25313F;">Create User</a></div>
<br />
</div>
</div>
<div class="col-md-11 main-section">
  <div class="content">
    <div class="sub-head text-center lead">Create User</div>
			<form class="form-group text-center" method="post">
				...
				<input type="text" name="lname" class="form-control input-defaulted" placeholder="LastName">
				<input type="text" name="email" class="form-control input-defaulted" placeholder="Email Adress">
				<input type="text" name="dprt" class="form-control input-defaulted" placeholder="Department">
				<input type="text" name="addr" class="form-control input-defaulted" placeholder="Adress">
				<select name="sex" class="form-control input-defaulted">
					<option name="sex">Sex</option>
					<option name="male">Male</option>
					<option name="female">Female</option>
				</select>
				<select name="role" class="form-control input-defaulted">
					<option name="role">Role</option>
					<option name="admin">Admin</option>
					<option name="moderator">Moderator</option>
					<option name="user">User</option>
				</select> 
				<input type="submit" name="submit" value="Submit" class="form-control input-defaulted action-button" placeholder="">
			</form>
  </div> </div>
    </div>
  </div>
