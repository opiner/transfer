...
<div class="col-sm-3 col-xs-6"align="left"><span class="logo"><a href='/' style="color:#fff">PaysFund</a></span></div>
<div class="col-sm-1 col-xs-6" align="right"><span class="bars"><i class="fa fa-bars" aria-hidden="true"></i></span></div>
<div class="col-sm-3 padding hidden-sm hidden-xs"><span class="white "><a href='/wallet-view' style="color:#fff">Wallet View</a></span></div>
...
<div class="col-md-11 main-section">
  <div class="content">
    <div class="sub-head text-center lead">Manage Wallet Users</div>
			<table class="table table-striped table-responsive table2">
				<tr><th>S/N</th><th>Firstname</th><th>Lastname</th><th>Email</th><th>Department</th><th>Sex</th><th>Role</th><th>Actions</th></tr>
				<tr><td>S/N</td><td>Firstname</td><td>Lastname</td><td>Email</td><td>Department</td><td>Sex</td><td>Role</td><td><button type="button" class="action btn btn-danger red">Delete</button><button type="button" class="action btn btn-info blue">Edit</button></td></tr>
				<tr><td>S/N</td><td>Firstname</td><td>Lastname</td><td>Email</td><td>Department</td><td>Sex</td><td>Role</td><td><button type="button" class="action btn btn-danger red">Delete</button><button type="button" class="action btn btn-info blue">Edit</button></td></tr>
				<tr><td>S/N</td><td>Firstname</td><td>Lastname</td><td>Email</td><td>Department</td><td>Sex</td><td>Role</td><td><button type="button" class="action btn btn-danger red">Delete</button><button type="button" class="action btn btn-info blue">Edit</button></td></tr>
				<tr><td>S/N</td><td>Firstname</td><td>Lastname</td><td>Email</td><td>Department</td><td>Sex</td><td>Role</td><td><button type="button" class="action btn btn-danger red">Delete</button><button type="button" class="action btn btn-info blue">Edit</button></td></tr>

				<!-- Submit Button -->
				<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><button class="btn btn-default action-button pull-right"><i class="fa fa-plus"></i> Add User</button></td></tr>
			</table>
  </div> </div>
    </div>
  </div>
